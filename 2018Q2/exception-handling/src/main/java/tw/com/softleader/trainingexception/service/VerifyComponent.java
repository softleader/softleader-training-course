...
public class VerifyComponent {
	...
	/** Hello 不能為空 */
	public Validations checkHellowRequird(TestForm testForm, User user) {
	...
	public Validations checkWorldRequird(TestForm testForm, User user) {
		...
		return new Validations(validation1, validation2);
	}
